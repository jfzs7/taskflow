...
echo "  [OK] Tunel zatrzymany."
echo ""

# 2. Zatrzymanie klastra Minikube
if command -v minikube &> /dev/null && minikube status &> /dev/null; then
    echo "[*] Zatrzymywanie klastra Minikube..."
    minikube stop
    echo "  [OK] Minikube został wyłączony."
else
    echo "  [INFO] Minikube jest już zatrzymany."
fi
echo ""
...
echo "  [OK] Kontenery Docker Compose zatrzymane."
echo ""
...
echo ""
echo "========================================"
echo "  [STOP] Wszystkie serwisy zostały zatrzymane!"
echo "========================================"
echo ""
